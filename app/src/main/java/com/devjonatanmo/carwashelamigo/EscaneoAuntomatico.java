...
public class EscaneoAuntomatico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_escaneo_auntomatico);
        ...
        BtnPlaca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                IntentIntegrator integrator = new IntentIntegrator( EscaneoAuntomatico.this);
    ...
    private void EnviarDatos () {
        try {
            Intent intent = new Intent( EscaneoAuntomatico.this, Factura.class);
